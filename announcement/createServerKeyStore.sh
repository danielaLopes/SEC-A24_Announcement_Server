...
keytool -importkeystore -destkeystore server/src/main/resources/crypto/server_keystore.jks -srckeystore server/src/main/resources/crypto/keystore.p12 -srcstoretype pkcs12 -alias ola
